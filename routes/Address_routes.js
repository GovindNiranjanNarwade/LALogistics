...
// route http://192.168.43.220:5000/api/v1/CreateAddress
//method post
router.route("/getAddressDetails").get(getAddressDetails)
// route http://192.168.43.220:5000/api/v1/getAddressDetails
//method get
router.route("/deleteAddress/:id").delete(deleteAddress)
// route http://192.168.43.220:5000/api/v1/deleteAddress
//method delete
router.route("/updateAddress/:id").put(updateAddress)
// route http://192.168.43.220:5000/api/v1/updateAddress
//method put
