...
//method get
router.route("/deleteBillingDetails/:id").delete(deleteBillingDetails)
// route http://192.168.43.220:5000/api/v1/billing/deleteBillingDetails
//method delete
router.route("/updateBillingDetails/:id").put(updateBillingDetails)
// route http://192.168.43.220:5000/api/v1/billing/updateBillingDetails
//method put
router.route("/getSingleBillingDetails/:id").get(getSingleBillingDetails)
